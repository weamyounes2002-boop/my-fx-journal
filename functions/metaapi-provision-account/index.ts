...
serve(async (req) => {
  ...
  try {
    ...
    const provisionUrl = `${METAAPI_PROVISIONING_BASE_URL}/users/current/accounts`;
    ...
    const deployUrl = `${METAAPI_PROVISIONING_BASE_URL}/users/current/accounts/${provisionData.id}/deploy`;
